...
from estoque.views import cadastrarProdutos, inserirProduto, vizualizarProdutos, editarProdutos, updateProdutos, listarProdutos, deleteProduto, entradaEstoque

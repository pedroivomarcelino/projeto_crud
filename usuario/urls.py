...
from usuario.views import cadastrarUsuario, inserirUsuario, indexUsuarios, visualizarUsuario, editarUsuario, updateUsuario, excluirUsuario
...
urlpatterns = [
    ...
    path('excluir-usuario/<int:id>', excluirUsuario, name='excluir-usuario'),
]
